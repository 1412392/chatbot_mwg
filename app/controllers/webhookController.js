...
const SentToClientButton = (id, text, intent, replyobject) => {
            ...
            GetProductInfoByURL(finalUrl, sessionId, ishaveProductEntity).then((value) => {
                ...
                if (!intent && ((!sessions[sessionId].product) && (!sessions[sessionId].province) && (!sessions[sessionId].district))) {
                    ...
                    Hoặc cách khác là "+ sessions[sessionId].gender + " có thể ra trực tiếp siêu thị TGDD để làm thủ tục trả góp luôn ạ. Lưu ý: cần mang đầy đủ giấy tờ và tiền trả trước ra siêu thị để được duyệt hồ sơ và nhận máy nhanh nhất</p>";
                                ...
                                setTimeout(() => {
                                    SentToClientButton(sender, jsonbuttonBrief, "ask_instalment+how", replyobject)
                                        .catch(console.error);
                                        ...
                                        if (result.SearchProductPhiResult != null) {
                                            ...
                                            APIGetProductDetail(urlApiProduct, argsProductDetail, function getResult(result) {
                                                ...
                                                if (result && result.GetProductResult.productErpPriceBOField) {
                                                    ...
                                                    APIGetSeoURLProduct(urlApiCategory, argsProductDetailGetSeoURL, function callback(seoURL) {
                                                        resultanswer += "<br />Thông tin chi tiết sản phẩm: " + "<a href='" + seoURL + "' target='_blank'>" + seoURL + "</a>" + "<br />";
                                                        if (IsPreoder(result.GetProductResult)) {
                                                        ...
                                                        else if ((parseInt(result.GetProductResult.productErpPriceBOField.webStatusIdField) == 2 || (result.GetProductResult.productErpPriceBOField.priceField).toString() === "0") && !IsPreoder(result.GetProductResult)) {
                                                                ...
                                                                APICheckZeroInstalment(urlwcfProduct, argCheckZeroInstalment, function callback(result) {
                                                                    ...
                                                                    if (isAsk0PTInstalment || ((sessions[sessionId].percent_instalment === 0 || sessions[sessionId].percent_instalment === 1) && !sessions[sessionId].isLatestAskNormalInstallment && !sessions[sessionId].isLatestAskCompanyForNormalInstalment
                                                                                    ...
                                                                                    packageInfo.forEach(function (packageDetail) {
                                                                                        ...
                                                                                        APIGetInstallmentResult(urlwcfProduct, argsInstalmentResult, function (InstallmentResult) {
                                                                                            ...
                                                                                            if (InstallmentResult && InstallmentResult.GetInstallmentResult2018Result) {
                                                                                                ...
                                                                                                setTimeout(() => {
                                                                                                    SentToClientButton(sender, anotheroptionbutton, "ask_instalment", replyobject)
                                                                                                        .catch(console.error);
                                                                        ...
                                                                        if (!sessions[sessionId].BriefID) {
                                                                            ...
                                                                            setTimeout(() => {
                                                                                SentToClientButton(sender, jsonbuttonBrief, intent, replyobject)
                                                                                    .catch(console.error);
                                                                            }, 600)
                                                                            ...
                                                                            if (sessions[sessionId].BriefID === -1)//không đủ đk trả góp
                                                                            {
                                                                                ...
                                                                                APIGetNormalInstallment(urlwcfProduct, argsGetListMonth, function (allpackages) {
                                                                                    ...
                                                                                    if (allpackages.GetListNormalInstallment2018Result) {
                                                                                        ...
                                                                                        setTimeout(() => {
                                                                                            SentToClientButton(sender, jsonbuttonMI, "ask_instalment", replyobject)
                                                                                                .catch(console.error);
                                                                                        }, 600)
                                                ...
                                                if (result && result.GetProductResult.productErpPriceBOField) {
                                                    ...
                                                    APIGetSeoURLProduct(urlApiCategory, argsProductDetailGetSeoURL, function callback(seoURL) {
                                                        ...
                                                        if (parseInt(result.GetProductResult.productErpPriceBOField.webStatusIdField) == 1 || (result.GetProductResult.productErpPriceBOField.priceField.toString() === "0")) {
                                                            ...
                                                            || (result.GetProductResult.productErpPriceBOField.priceField).toString() === "0") && !IsPreoder(result.GetProductResult)) {
                                                            ...
                                                            if (productPrice >= 1200000) {
                                                                ...
                                                                APICheckZeroInstalment(urlwcfProduct, argCheckZeroInstalment, function callback(result) {
                                                                    ...
                                                                    setTimeout(() => {
                                                                        SentToClientButton(sender, jsonbuttonInstalment, "ask_instalment+issupportinstalment", replyobject)
                                                                            .catch(console.error);
                                                                    ...
                                                                    APIGetInstallmentResult(urlwcfProduct, newargsInstalmentResult, function (InstallmentResult) {
                                                                        if (InstallmentResult) {
                                                                            ...
                                                                            if (InstallmentResult.GetInstallmentResult2018Result) {
                                                                                ...
                                                                                setTimeout(() => {
                                                                                    SentToClientButton(sender, anotheroptionbutton, "ask_instalment+package0d", replyobject)
                                                                                        .catch(console.error);
                     ...
                     Lưu ý: " + sessions[sessionId].gender + " nên chọn công ty tài chính khác để tỷ lệ duyệt hồ sơ thành công cao hơn ạ.</br>";
                        ...
                        Do vậy, "+ sessions[sessionId].gender + " có thể nhờ người thân hoặc bạn bè đủ từ 20 đến 60 tuổi đứng tên làm hồ sơ giúp " + sessions[sessionId].gender + " ạ";
                                var jsonbuttonBrief = getButtonBriefSupport(sender, siteid, replyobject, resultanswer);
                                setTimeout(() => {
                                    SentToClientButton(sender, jsonbuttonBrief, "ask_instalment+agecondition", replyobject)
                                        .catch(console.error);
                         ...
                         Ví dụ, nếu "+ sessions[sessionId].gender + " đang vay tiền tại <span style='color:green'>FECredit</span> thì có thể làm hồ sơ mua trả góp tại công ty <span style='color:red'>HomeCredit</span> ạ</br>";
                            ...
                            logerror.WriteLogToFile(ERRORFILE_PATH, "Error at 4169: " + err);
                        }
                    }
